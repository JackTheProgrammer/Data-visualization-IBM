...
# %%
# Next we will create a scatter plot by using the add_trace function and 
# use the go.scatter() function within it
# In go.Scatter we define the x-axis data,y-axis data 
# and define the mode as markers with color of the marker as blue
...
# %%
# Use plotly express bar chart function px.bar. 
# Provide input data, x and y axis variable, and title
# of the chart. This will give average pass percentage per class
...
heights_array = np.random.normal(160, 10, 200)
...
fig.update_layout(
    title="Distance vs deparutre time",
